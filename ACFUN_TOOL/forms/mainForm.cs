...
namespace Article
{
    public partial class Acfun : RibbonForm
    {
        ...
        {
            userReg regform = new userReg();
            regform.Show();
        }

        private void button_check_Click(object sender, EventArgs e)
        {
            checkUser checkform = new checkUser();
            checkform.Show();
        }

        private void button1_Click(object sender, EventArgs e)
        {
            qianmouserSet qianmoform = new qianmouserSet();
            qianmoform.Show();
        }
        ...
        private void checkIn()
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                //webutil.SaveCookie(dt.Rows[i]["username"].ToString());
                string s1 = webutil.checkIn(webutil.RestoreCookie(dt.Rows[i]["username"].ToString()));
        ...
        {
            qianmouserReg qianmoregform = new qianmouserReg();
            qianmoregform.Show();
        }
    }
}